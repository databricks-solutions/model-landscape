...
- the Performance page should now expose `Per-Bin Breakdown Controls` (`Binning Mode`, `Bin Count`, `Custom Bin Edges`, and outlier controls) and the all-feature per-bin impact chart should visibly change when you apply those controls
