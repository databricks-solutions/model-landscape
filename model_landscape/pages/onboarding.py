                                                    ...
                                                    dbc.Col(
                                                        [
                                                            ...
                                                            dbc.Input(
                                                                ...
                                                                placeholder="model_landscape_ui",
                                                            ),
                                                        ],
                                                        md=4,
                                                        style=form_style,
                    ...
                    dbc.CardBody(
                        [
                            ...
                            html.P(
                                ...
                                "and MLflow experiment or registered model, then let Model Landscape infer the draft for you. "
                        ...
                        [
                            ...
                            html.Div(
                                [
                                    ...
                                    html.Small(
                                        "Model Landscape compares this fixed known-good window to the latest window of the same length.",
