...
- let the Performance page choose the drift metric, explicitly select the tracked drift features, optionally overlay drift thresholds on the lower drift chart, and explain the feature-impact bars in-product with “Weighted Contribution” / “Current Window Share (%)” wording instead of the older ambiguous labels
