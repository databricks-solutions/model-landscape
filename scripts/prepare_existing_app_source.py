...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--lakebase-schema", default="model_lens_ui")
...
def _write_refresh_job_payload(output_dir: Path, args: argparse.Namespace, wheel_name: str) -> Path:
...
def main() -> None:
    ...
    if args.workspace_source_path:
        ...
        job_payload_path = _write_refresh_job_payload(output_dir, args, copied_wheel.name)
